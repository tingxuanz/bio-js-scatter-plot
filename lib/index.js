...
module.exports = biojsvisscatterplot = function(init_options)
{
    ...
    //Setup the options for a small graph this just allows the user to choose (options.garph_size)
    //Changes graph elements such as font size, radius of the circules etc
