...
module.exports = biojsvisscatterplot = function(init_options)
{
    ...
    this.setup_margins = function(graph){
        ...
        if(options.graph_size == "small") {
            ...
            page_options.margin_left = options.margin_small.left;
            ...
            page_options.full_height = options.height.small  + options.margin.top + options.margin.bottom;
        } else {
            ...
            page_options.height = options.height.large; 
            ...
            page_options.full_height = options.height.large  + options.margin.top + options.margin.bottom;
        }
        ...
        if(options.graph_size !== "small") {
            ...
            for (i = 0; i < options.subtitles.length; i ++) {
                svg.append("text")
                    ...
                    .attr("y", function() {
                            num = page_options.margin.top/height_divisor - (parseInt(options.text_size.large, 10) * (i + 1));
                            if (num <= 0) {
                                count ++;
                            }
                            return 0 - num;
            ...
            // Change the height of the graph to account for the number of subtitles
            if (count != 0) {
            //page_options.margin.top += (parseInt(options.text_size.large, 10) * count; 
            }
        }
        //End subtitle setup
