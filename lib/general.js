     ...
     */
    var setup_colours_for_group = function (array_group, new_array, number_of_colours) {
...
*/
    ...
    wrap = function (text, width) {
      //var lineNumber = 0,// this needs to be in loop so that it incremneted within each legend and for next legend it goes to zero again
      var lineHeight = 1.1;
      text.each(function() {
        var text = d3.select(this),
    ...
    setup_D3_legend = function (graph, sample_list) {
        ...
        //       }); //end on_click button
         ...
         //Add legend text
         //var ref_type = "ensemblID"; //add
         //var symbol = "GATA3";//add
         legend.append('text')
                ...
                .text(function (sample_type_list,i) {
                  if(legend_type == "probes") {
                    if(options.ref_type == "ensemblID" || options.ref_type=="miRNA") {
                    ...
                    var word = legend_sample_type.replace(/(.{12}) /g, "$&\n");
                    if (probeInfo[sample_type_list]['mapping'] == "yes") {
                      ...
                      var word = sample_type_list.replace(/(.{17}) /g, "$&\n")
                      return word;
                  }
 		        }).call(wrap,10)
